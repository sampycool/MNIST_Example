...
import com.iot.modules.Classification;
import com.iot.modules.Classifier;
//contains logic for reading labels, creating classifier, and classifying
import com.iot.modules.TensorFlowClassifier;
//class for drawing MNIST digits by finger
import com.iot.views.DrawModel;
//class for drawing the entire app
import com.iot.views.DrawView;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    TensorFlowClassifier tf_classifier = TensorFlowClassifier.create(getAssets(), "TensorFlow",
                            "opt_mnist_convnet_tf.pb", "labels.txt", PIXEL_WIDTH,
                            "input", "output", true);
                    TensorFlowClassifier keras_classifier = TensorFlowClassifier.create(getAssets(), "Keras",
                            "opt_mnist_convnet_keras.pb", "labels.txt", PIXEL_WIDTH,
                            "conv2d_1_input", "dense_2/Softmax", false);
                    mClassifiers.add(tf_classifier);
                    mClassifiers.add(keras_classifier);
//                    mClassifiers.add(
